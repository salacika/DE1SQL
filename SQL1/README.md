...
UPDATE: Many of you uploaded only some source files. This is just the first step! You also have to load these files into your local MySQL by creating the appropiate sql script. Then upload this script to GitHub together with your source files.
